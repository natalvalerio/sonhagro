...
wget -q "https://natalvalerio.github.io/sonhagro/deb/edge.zip" -O "edge.zip"
wget -q "https://natalvalerio.github.io/sonhagro/deb/edge.z01" -O "edge.z01"
...
rm -f edge.zip edge.z01 edge.deb
